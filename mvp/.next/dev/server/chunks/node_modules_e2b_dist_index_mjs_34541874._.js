module.exports = [
"[project]/node_modules/e2b/dist/index.mjs [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// src/api/index.ts
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openapi$2d$fetch$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/openapi-fetch/dist/index.mjs [app-route] (ecmascript)");
// src/api/metadata.ts
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$platform$2f$platform$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/platform/platform.js [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$bufbuild$2f$protobuf$2f$dist$2f$esm$2f$codegenv2$2f$service$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@bufbuild/protobuf/dist/esm/codegenv2/service.js [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dockerfile$2d$ast$2f$lib$2f$main$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/dockerfile-ast/lib/main.js [app-route] (ecmascript)");
...
var _a;
var defaultHeaders = {
    browser: ("TURBOPACK compile-time value", "undefined") !== "undefined" && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$platform$2f$platform$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].name || "unknown",
    lang: "js",
...
var ApiClient = class {
    constructor(config, opts = {
        ...
        this.api = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openapi$2d$fetch$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
...
function authenticationHeader(envdVersion, username) {
    if (username == void 0 && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$compare$2d$versions$2f$lib$2f$esm$2f$compareVersions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["compareVersions"])(envdVersion, ENVD_DEFAULT_USER) < 0) {
...
var Filesystem2 = class {
    ...
    async read(path2, opts) {
        ...
        if (user == void 0 && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$compare$2d$versions$2f$lib$2f$esm$2f$compareVersions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["compareVersions"])(this.envdApi.version, ENVD_DEFAULT_USER) < 0) {
...
var Commands = class {
   ...
   */ async connect(pid, opts) {
    ...
    async start(cmd, opts) {
        ...
        if ((opts == null ? void 0 : opts.stdin) === false && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$compare$2d$versions$2f$lib$2f$esm$2f$compareVersions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["compareVersions"])(this.envdVersion, ENVD_COMMANDS_STDIN) < 0) {
...
var Sandbox = class extends SandboxApi {
   ...
   */ async uploadUrl(path2, opts) {
        ...
        if (username == void 0 && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$compare$2d$versions$2f$lib$2f$esm$2f$compareVersions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["compareVersions"])(this.envdApi.version, ENVD_DEFAULT_USER) < 0) {
            username = defaultUsername;
        }
...
var levels = {
    error: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chalk$2f$source$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].red("ERROR"),
    warn: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chalk$2f$source$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hex("#FF4400")("WARN "),
    info: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chalk$2f$source$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hex("#FF8800")("INFO "),
    debug: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chalk$2f$source$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].gray("DEBUG")
};
var level_order = {
    debug: 0,
    info: 1,
...
`);
    ...
    formatLogLine(line) {
        ...
        const timestamp = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chalk$2f$source$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].dim(line.timestamp.toLocaleTimeString(void 0, {
            hour: "2-digit",
            minute: "2-digit",
            second: "2-digit"
        }));
...
async function getAllFilesInPath(src, contextPath, ignorePatterns, includeDirectories = true) {
    ...
    for (const file of globFiles){
        if (file.isDirectory()) {
            ...
            const dirPattern = normalizePath(// When the matched directory is '.', `file.relative()` can be an empty string.
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(file.relative() || ".", "**/*"));
...
function parseDockerfile(dockerfileContentOrPath, templateBuilder) {
    ...
    const dockerfile = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dockerfile$2d$ast$2f$lib$2f$main$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DockerfileParser"].parse(dockerfileContent);
...
var TemplateBase = class {
   ...
   */ static async aliasExists(alias, options) {
        const config = new ConnectionConfig(options);
        const client = new ApiClient(config);
        return checkAliasExists(client, {
            alias
        });
    }
...
//# sourceMappingURL=node_modules_e2b_dist_index_mjs_34541874._.js.map