...
"[project]/node_modules/@clerk/backend/dist/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var import_retry = __turbopack_context__.r("[project]/node_modules/@clerk/shared/dist/runtime/retry.js [app-client] (ecmascript)");
var import_url = __turbopack_context__.r("[project]/node_modules/@clerk/shared/dist/runtime/url.js [app-client] (ecmascript)");
var import_error = __turbopack_context__.r("[project]/node_modules/@clerk/shared/dist/runtime/error.js [app-client] (ecmascript)");
var import_keys2 = __turbopack_context__.r("[project]/node_modules/@clerk/shared/dist/runtime/keys.js [app-client] (ecmascript)");
...
// src/runtime.ts
var import_crypto = __turbopack_context__.r("[project]/node_modules/@clerk/backend/dist/runtime/browser/crypto.mjs [app-client] (ecmascript)");
...
var UserAPI = class extends AbstractAPI {
    ...
    async getUserOauthAccessToken(userId, provider) {
        ...
        if (hasPrefix) {
            (0, import_deprecated.deprecated)("getUserOauthAccessToken(userId, provider)", "Remove the `oauth_` prefix from the `provider` argument.");
        }
        return this.request({
            method: "GET",
...
// src/api/request.ts
var import_error2 = __turbopack_context__.r("[project]/node_modules/@clerk/shared/dist/runtime/error.js [app-client] (ecmascript)");
...
function assertValidPublishableKey(val) {
    (0, import_keys.parsePublishableKey)(val, {
        fatal: true
    });
}
...
var import_isomorphicAtob = __turbopack_context__.r("[project]/node_modules/@clerk/shared/dist/runtime/isomorphicAtob.js [app-client] (ecmascript)");
...
var import_buildAccountsBaseUrl = __turbopack_context__.r("[project]/node_modules/@clerk/shared/dist/runtime/buildAccountsBaseUrl.js [app-client] (ecmascript)");
var import_url2 = __turbopack_context__.r("[project]/node_modules/@clerk/shared/dist/runtime/url.js [app-client] (ecmascript)");
...
var import_jwtPayloadParser = __turbopack_context__.r("[project]/node_modules/@clerk/shared/dist/runtime/jwtPayloadParser.js [app-client] (ecmascript)");
// src/createRedirect.ts
var import_buildAccountsBaseUrl2 = __turbopack_context__.r("[project]/node_modules/@clerk/shared/dist/runtime/buildAccountsBaseUrl.js [app-client] (ecmascript)");
...
// src/internal.ts
var import_authorization_errors = __turbopack_context__.r("[project]/node_modules/@clerk/shared/dist/runtime/authorization-errors.js [app-client] (ecmascript)");
// src/tokens/verify.ts
var import_error3 = __turbopack_context__.r("[project]/node_modules/@clerk/shared/dist/runtime/error.js [app-client] (ecmascript)");
// src/tokens/keys.ts
var cache = {};
var lastUpdatedAt = 0;
...
var import_pathToRegexp = __turbopack_context__.r("[project]/node_modules/@clerk/shared/dist/runtime/pathToRegexp.js [app-client] (ecmascript)");
...
"[project]/node_modules/@clerk/nextjs/dist/cjs/server/createClerkClient.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var import_backend = __turbopack_context__.r("[project]/node_modules/@clerk/backend/dist/index.js [app-client] (ecmascript)");
var import_constants = __turbopack_context__.r("[project]/node_modules/@clerk/nextjs/dist/cjs/server/constants.js [app-client] (ecmascript)");
...
const createClerkClientWithOptions = (options)=>(0, import_backend.createClerkClient)({
...
"[project]/node_modules/@clerk/nextjs/dist/cjs/runtime/browser/safe-node-apis.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@clerk/nextjs/dist/cjs/server/fs/utils.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var import_safe_node_apis = __toESM(__turbopack_context__.r("[project]/node_modules/@clerk/nextjs/dist/cjs/runtime/browser/safe-node-apis.js [app-client] (ecmascript)"));
...
"[project]/node_modules/@clerk/nextjs/dist/cjs/server/keyless-custom-headers.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var import_headers = __turbopack_context__.r("[project]/node_modules/next/headers.js [app-client] (ecmascript)");
async function collectKeylessMetadata() {
    var _a, _b, _c, _d, _e, _f;
    const headerStore = await (0, import_headers.headers)();
    return {
        nodeVersion: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].version,
        nextVersion: getNextVersion(),
        npmConfigUserAgent: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.npm_config_user_agent,
        // eslint-disable-line
        userAgent: (_a = headerStore.get("User-Agent")) != null ? _a : "unknown user-agent",
        port: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.PORT,
        // eslint-disable-line
...
function detectCIEnvironment() {
    ...
    return ciIndicators.some((indicator)=>{
        const value = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env[indicator];
        if (value === void 0) {
            return false;
        }
...
function getNextVersion() {
    var _a;
    try {
        return (_a = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].title) != null ? _a : "unknown-process-title";
    } catch  {
        return void 0;
    }
}
...
"[project]/node_modules/@clerk/nextjs/dist/cjs/server/keyless-node.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var import_createClerkClient = __turbopack_context__.r("[project]/node_modules/@clerk/nextjs/dist/cjs/server/createClerkClient.js [app-client] (ecmascript)");
var import_utils = __turbopack_context__.r("[project]/node_modules/@clerk/nextjs/dist/cjs/server/fs/utils.js [app-client] (ecmascript)");
var import_keyless_custom_headers = __turbopack_context__.r("[project]/node_modules/@clerk/nextjs/dist/cjs/server/keyless-custom-headers.js [app-client] (ecmascript)");
const CLERK_HIDDEN = ".clerk";
const CLERK_LOCK = "clerk.lock";
function updateGitignore() {
    const { existsSync, writeFileSync, readFileSync, appendFileSync } = (0, import_utils.nodeFsOrThrow)();
...
function safeParseClerkFile() {
    const { readFileSync } = (0, import_utils.nodeFsOrThrow)();
    try {
...
const lockFileWriting = ()=>{
    const { writeFileSync } = (0, import_utils.nodeFsOrThrow)();
    isCreatingFile = true;
...
const unlockFileWriting = ()=>{
    const { rmSync } = (0, import_utils.nodeFsOrThrow)();
    try {
        rmSync(CLERK_LOCK, {
            force: true,
            recursive: true
...
async function createOrReadKeyless() {
    const { writeFileSync, mkdirSync } = (0, import_utils.nodeFsOrThrow)();
    ...
    const keylessHeaders = await (0, import_keyless_custom_headers.collectKeylessMetadata)().then(import_keyless_custom_headers.formatMetadataHeaders).catch(()=>new Headers());
...
//# sourceMappingURL=node_modules_%40clerk_29bae7d9._.js.map